...
class VentanaPrincipal(QWidget):
    def __init__(self, usuario: Usuario):
        ...
        layout = QVBoxLayout()
        #layout.addWidget(QLabel(f"Bienvenido, {usuario.nombre_completo} (rol: {usuario.activo})"))
        # aquí irán los módulos reales: inventario, códigos de barras, etc. , activo={self.activo}
